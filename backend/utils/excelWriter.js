  ...
  try {
    ...
    const augmented = data.map((row, idx) => {
      ...
      return {
        ...
        commerce_cloud_availability: evalData?.commerceCloudAvailability || '',
        commerce_on_premise_availability: evalData?.commerceOnPremiseAvailability || '',
        deployment_availability_note: evalData?.deploymentAvailabilityNote || '',
